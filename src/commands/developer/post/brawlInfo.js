...
const section1 =
    ...
    `* Detailed user stats tracking for event participation\n` +
    `* Tournament progress and user stats are automatically saved, enabling resumption even in the event of a crash.\n` +
    `* Creation of server events to promote community activities\n` +
    `\`\`\``;
...
const section4 =
    `## Support\n` +
    `:crown: **Become a <@&${config.roleID.serverSubscriber}> if you appreciate the work and effort I put into this community and want to support me!** Hosting the bot online isn't free and it takes time to develop and maintain this unique community feature to bring to you.\n\n` +
